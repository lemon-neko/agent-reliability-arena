...
import pytest
from arena.domain import AgentProfile, Run, RunStatus, TraceKind
from arena.engine import ArenaEngine
from arena.evaluation import DeterministicEvaluator
from arena.providers import DeterministicProvider, OpenAICompatibleProvider
from arena.scenarios import ScenarioCatalog
from arena.tracing import TraceRecorder, redact
...
def test_provider_rejects_malformed_structured_tool_output(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("arena.providers.httpx.post", lambda *args, **kwargs: Response())
